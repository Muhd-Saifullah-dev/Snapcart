    ...
    return (
        <div className="w-[95%] sm:w-[90%] md:w-[80%] mx-auto mt-8 mb-24 relative ">
            ...
            <motion.h2
                ...
                className="text-center text-2xl sm:text-3xl md:text-4xl font-bold text-green-700 mb-10"
            >
                🛒 Your Shopping Cart
            </motion.h2>
            {cartData.length === 0 ? (
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        <AnimatePresence>
                            {cartData.map((item, index) => (
                                ...
                                >
                                    <div className="relative w-28 h-28  sm:w-24 sm:h-24 md:w-28 shrink-0 rounded-xl overflow-hidden bg-gray-50">
                                        <Image
                                            src={item.image}
                                            alt={item.name}
                                            fill
                                            className="object-contain p-3 transitionn-transform duration-300 hover:scale-105"
                                        />
                                    </div>
