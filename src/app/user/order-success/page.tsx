    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white ">
            ...
            <motion.p
                ...
                className="text-gray-500 mt-3 text-sm md:text-base max-w-md "
            >
                Thank you for shopping with us! Your order has been placed and
                its being processed.You can track its progress in your{' '}
            ...
            >
                <div className="absolute top-20 left-[10%] h-2 w-2 bg-green-400 rounded-full animate-bounce " />
                <div className="absolute top-32 left-[30%] h-2 w-2 bg-green-400 rounded-full animate-pulse " />
                <div className="absolute top-24 left-[50%] h-2 w-2 bg-green-400 rounded-full animate-bounce " />
                <div className="absolute top-16 left-[70%] h-2 w-2 bg-green-400 rounded-full animate-pulse " />
            </motion.div>
        </div>
    );
}
