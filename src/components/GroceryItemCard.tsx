        ...
        >
            <div className="relative w-full aspect-4/3 bg-gray-50 overflow-hidden group">
                <Image
                    ...
                    fill
                    alt={item.name}
                    sizes="(max-width:758px) 100vw,25vw"
            ...
            <div className="p-4 flex flex-col flex-1">
                ...
                {!cartItem ? (
                    <motion.button
                        className="mt-4 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white rounded-full py-2 text-sm font-bold transition-all"
                        whileTap={{ scale: 0.96 }}
                        onClick={() =>
