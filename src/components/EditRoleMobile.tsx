    ...
    <div className="flex flex-col items-center min-h-screen p-6 w-full ">
      ...
      >
        ...
        <input
          type="tel"
          id="mobile"
          className="w-64 md:w-80 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-green-500 focus:outline-none textx-gray-800"
      ...
      <motion.button
       initial={{
        ...
        onClick={handleEditRoleAndMobile}
        className={`inline-flex items-center gap-2 font-semibold py-3 px-8 rounded-2xl shadow-md transition-all duration-200 mt-20 w-[200px] ${
            selectedRole && mobile.length===11 ? "bg-green-600 hover:bg-green-700 text-white" :"bg-gray-300 text-gray-500 cursor-not-allowed"
        } `}
      >
       Go to Home
       <ArrowRight/>
