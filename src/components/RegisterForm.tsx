  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative">
      ...
      >
        ...
        <div className="relative">
          ...
          {showpassword ? (
            ...
            <EyeIcon
              className="absolute right-3 top-3.5 w-5 h-5   text-gray-500 cursor-point"
              onClick={() => setShowpassword(!showpassword)}
            />
          )}
        </div>
        ...
        <button type='button' className="w-full flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 py-3 rounded-xl text-gray-700 font-medium transition-all duration-200" onClick={()=>signIn("google",{callbackUrl:"/"})}>
      ...
      <p className="cursor-pointer text-gray-600 mt-6 text-sm flex items-center gap-1">
        ...
        <span className="text-green-600" onClick={() => router.push('/login')}>
          Sign in
        </span>{' '}
      </p>
    </div>
