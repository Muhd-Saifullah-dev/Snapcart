...
import { DollarSign, Package, Truck, User, Users } from 'lucide-react';
...
function AdminDashboardClient({ earning, stats, chartData }: IPropType) {
    ...
    return (
        <div className="pt-28 w-[90%] md:w-[80%] mx-auto">
            <div className="flex  flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10">
                ...
                <select
                    className="border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-green-500 outline-none w-full sm:w-auto"
                ...
                {stats.map((s, i) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="bg-white border border-gray-100 shadow-d rounded-2xl p-5 flex items-center gap-4 hover:shadow-lg transition-all"
                        >
